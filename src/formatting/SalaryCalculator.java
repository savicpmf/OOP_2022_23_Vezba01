...
class SalaryCalculator {
    ...
    private static final double RATES_OF_SOCIAL_INS = 7;
    private static final int SALARY_BOUNDARY = 3000;

    public static void main(String[] args) {
        int grossSalary = 1000;
        int net = SalaryCalculator.calculateNetSalary(grossSalary);
        SalaryCalculator.printIncomeInformation(grossSalary, net);
    }
    ...
    public static int calculateNetSalary(int grossSalary) {
        ...
        double deductionSocialInsurance = grossSalary * (RATES_OF_SOCIAL_INS / 100);
